...
class SpectralNet:
    def __init__(
        ...
        siamese_hiddens: list = [128, 521, 512, 128],
        ...
        spectral_hiddens: list = [128, 512, 512, 10],
    ...
    def predict(self, X: torch.Tensor) -> np.ndarray:
        ...
        cluster_assignments_tensor = torch.tensor(cluster_assignments, dtype=torch.int64, device=self.device)
        return cluster_assignments_tensor
